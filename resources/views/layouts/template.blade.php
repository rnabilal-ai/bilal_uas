                            ...
                            <nav id="mobile-menu-four">
                                <ul>
                                    <li><a href="index.html">Home</a>
                                        <ul class="submenu submenu-three">
                                            <li>
                                        ...
                                        <ul class="submenu ">
                                            <li>
                                                ...
                                                <ul class="submenu ">
                                                    ...
                                                    <li>
                                                        <a href="shop-2-col-right-sidebar.html">Shop 2 Right Sidebar</a>
                                                    </li>
                                                    <li>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="footer-widget mb-30">
                            <div class="footer-logo">
                                <a href="index.html"><img src="img/footer/footer-logo.png" class="img-fluid" alt=""></a>
                            </div>
                            ...
                            <div class="footer-payment mt-40">
                                ...
                                <a href="#"><img src="img/footer/payment.png" class="img-fluid" alt=""></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-widget mb-30 ml-50">
                            ...
                            <ul class="links">
                                <li><a href="shop.html">Accessories (47)</a></li>
                                <li><a href="shop.html">Mobile (26)</a></li>
                                <li><a href="shop.html">Headphone (40)</a></li>
                                <li><a href="shop.html">Laptop (19)</a></li>
                                <li><a href="shop.html">Television (32)</a></li>
                                <li><a href="shop.html">Smartwatch (24)</a></li>
                                <li><a href="shop.html">Speaker (33)</a></li>
                                <li><a href="shop.html">Uncategorized (15)</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
